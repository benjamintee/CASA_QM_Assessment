...
ax_tern = fig.add_axes(
    [0.01, 0.59, 0.33, 0.30],  # [left, bottom, width, height]
    zorder=10
)
...
legend_ax = fig.add_axes([0.01, 0.63, 0.23, 0.21])
...
legend_ax.set_xticklabels(["High", "Middle", "Low"], fontsize=10)
legend_ax.set_yticklabels(["Low", "Middle", "High"], fontsize=10)

legend_ax.set_xlabel("⟵ Household income (AHC)", fontsize=11)
legend_ax.set_ylabel("Annual energy cost ⟶", fontsize=11)
